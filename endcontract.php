...
if ($ir['Top'] == 0 && $role == 'Top') { print" You don't have a Top laner";}
 if ($ir['Mid'] == 0 && $role == 'Mid') { print" You don't have a Mid Laner";}
  if ($ir['Jungle'] == 0 && $role == 'Jungle') { print" You don't have a Jungler";}
if ($ir['Support'] == 0 && $role == 'Support') { print" You don't have a Support";}
 if ($ir['ADC'] == 0 && $role == 'ADC') { print" You don't have an ADC";}
 if ($ir['Coach'] == 0 && $role == 'Coach') { print" You don't have a Coach";}
 if ($ir['Analyst'] == 0 && $role == 'Analyst') { print" You don't have an Analyst";}
else 
{
$costo = $costo;
print "You have ended {$re['name']}'s contract and receieved {$cost}.";
...
mysql_query("UPDATE players SET userid=0 WHERE playerid={$_GET['u']}", $c);
}
}
else 
{
